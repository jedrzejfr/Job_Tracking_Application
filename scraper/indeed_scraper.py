...
if __name__ == "__main__":
    job_soup = load_indeed_jobs_div("software engineer", "London")
    jobs_list, num_listings = extract_job_information_indeed(job_soup, ['titles', 'companies', 'links', 'date_listed'])
    print(jobs_list)
